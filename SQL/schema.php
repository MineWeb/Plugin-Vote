...
class VoteAppSchema extends CakeSchema
{
    ...
    public $vote__configurations = array(
        ...
        'global_command_plural' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
        'limit_get_not_collected' => array('type' => 'integer', 'null' => true, 'default' => null, 'unsigned' => false),
        'indexes' => array(
