            ...
            <?php $im = 0; foreach($months as $var) { $im++; ?>
                <div class="tab-pane <?php if($im == $thism): echo "active"; endif; ?>" id="<?= $var ?>">
                    ...
                    <?php } else { ?>
                        ...
                        <h4 class="text-center"><?= $Lang->get('VOTE__ADMIN_1_TOP') ?> <?= $vote_this_year[$im][0][0]['count'] ?> vote<?php if($vote_this_year[$im][0][0]['count'] > 1){?>s<?php } ?> <?= $Lang->get('VOTE__ADMIN_2_TOP') ?></h4>
                    <?php } ?>
                </div>
            <?php } ?>
        </div>
            ...
            <?php $im = 0; foreach($months as $var) { $im++; ?>
                <div class="tab-pane <?php if($im == "1"): echo "active"; endif; ?>" id="last-<?= $var ?>">
                    ...
                    <?php } else { ?>
                        ...
                        <h4 class="text-center"><?= $Lang->get('VOTE__ADMIN_1_TOP') ?> <?= $vote_last_year[$im][0][0]['count'] ?> vote<?php if($vote_last_year[$im][0][0]['count'] > 1){?>s<?php } ?> <?= $Lang->get('VOTE__ADMIN_2_TOP') ?></h4>
                    <?php } ?>
                </div>
            <?php } ?>
        </div>
